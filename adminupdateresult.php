<?php 
    ...
    $Rid=$_GET['Rid'];
    $sql="Select * from results where Rid='$Rid'";
...
<body>
  ...
  <?php
    ...
    if(isset($_POST['Submit'])){
      ...
      $sql="Update results set Competition='$Competition',Gameweek='$Gameweek',Hometeam='$Hometeam',Awayteam='$Awayteam',Venue='$Venue',Matchdate='$Matchdate',Matchtime='$Matchtime' where Rid='$Rid'";
      $result=mysqli_query($conn,$sql);
      if($result){
