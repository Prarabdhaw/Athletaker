...
<body>
  ...
  <?php
    ...
    if(isset($_POST['Submit'])){
      ...
      $sql="Insert into fixtures(Competition, Gameweek, Hometeam, Awayteam, Venue, Matchdate, Matchtime) Values('$Competition','$Gameweek','$Hometeam','$Awayteam','$Venue','$Matchdate','$Matchtime')";
